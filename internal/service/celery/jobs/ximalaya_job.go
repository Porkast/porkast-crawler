...
func getXimalayaEntryUrlList() (urlList []string) {
	...
	urlList = []string{
		...
		consts.XIMALAYA_CATEGORY_URL_LATEST,
		...
		consts.XIMALAYA_CATEGORY_URL_SMALL_LANG_CHANNEL,
		consts.XIMALAYA_CATEGORY_URL_CAR_CHANNEL,
		consts.XIMALAYA_CATEGORY_URL_LATEST_CHANNEL,
	}
