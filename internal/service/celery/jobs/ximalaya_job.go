...
func getXimalayaEntryUrlList() (urlList []string) {
	...
	urlList = []string{
		consts.XIMALAYA_CATAGORY_URL,
		consts.XIMALAYA_CATAGORY_URL_HOT,
		consts.XIMALAYA_CATAGORY_URL_MUSIC,
		consts.XIMALAYA_CATAGORY_URL_ENTERTAINENT,
		consts.XIMALAYA_CATAGORY_URL_MUSIC,
		consts.XIMALAYA_CATAGORY_URL_FOREIGN_LANGUAGE,
		consts.XIMALAYA_CATAGORY_URL_CHILDREN,
		consts.XIMALAYA_CATAGORY_URL_BUSINESS,
	}
